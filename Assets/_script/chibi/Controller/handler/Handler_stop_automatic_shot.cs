...
{
	[ CreateAssetMenu( menuName="chibi/controller/handler/stop_automatic_shot" ) ]
	public class Handler_stop_automatic_shot : Handler
	{
		public override void action( Controller_motor controller )
		{
			...
			if ( controller_danmaku )
				controller_danmaku.automatic_shot = false;
		}
	}
}
